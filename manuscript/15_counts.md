...
Acknowledgment to Jeff Leek for much of the code and organization of this chapter.
...
Thus {$$}e^{\beta_0}{/$$} is the geometric mean of hits on
...
{$$}e^{\beta_1}{/$$} is the expected relative increase in the
